...
impl Plugin for CreaturePlugin {
	fn build(
		...
		app
		.add_fixed_timestep_system("my_fixed",0,creature_casts::creature_casts.label("c_casts"))
		.add_fixed_timestep_system("my_fixed",0,set_creature_state::set_creature_state.label("set_c_state").after("c_casts"))
